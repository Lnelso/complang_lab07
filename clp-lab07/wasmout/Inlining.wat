(module 
  ...
  (func $Inlining_inlinedSquare (param i32) (result i32) 
    get_local 0
    get_local 0
    i32.mul
  )

  (func $Inlining_test (param i32) (result i32) (local i32 i32 i32 i32)
    i32.const 2
    set_local 2
    get_local 2
    get_local 2
  ...
  (export "Inlining_main" (func $Inlining_main))
  (func $Inlining_main (local i32 i32 i32 i32 i32)
    get_global 0
    i32.const 0
    i32.add
    i32.const 53
